...
This devcontainer feature was originally created by @bdsoha and the original can be found here https://github.com/bdsoha/devcontainers. I have only added some cleanup, cert verifcation and testing to his original idea
